...
We're glad you're considering contributing to FSH Online! Below are a few best practices that we recommend for all contributions.
...
- Follow the code style and conventions as enforced by the lint configuration and as evidenced by the existing code.
  - FSH Online uses [ESLint](https://eslint.org/) for code linting.
...
- Follow the code formatting as enforced by the formatter configuration.
  - FSH Online uses [Prettier](https://prettier.io/) for code formatting.
